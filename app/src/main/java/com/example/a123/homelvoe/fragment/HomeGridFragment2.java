 ...
 */
public class HomeGridFragment2 extends Fragment {
    ...
    public void wangluo(){
        ...
        x.http().get(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                name.add(imagetype.getList().get(14).getParent_cate_name());
                image.add(imagetype.getList().get(14).getParent_cate_img_url());
